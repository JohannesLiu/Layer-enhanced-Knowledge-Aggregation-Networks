...
sys.path.append("D:/PycharmProjects/LeKAN")
os.chdir("D:/PycharmProjects/LeKAN")
...
# instance_triple: 三元组
# instance_scope: 每一种instalce_triple 的范围， 开始，结束
# test_len：每一段话的长度
# test_label: 每一段话的关系label
# test_word: wordID
# test_pos1: entity1位置
# test_pos2: entity2位置
# test_mask: 每个词的相对于entities 的位置
